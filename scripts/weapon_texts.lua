...
return {
  ...
  Chess_Bishop_Charge_Description = "Fly in a diagonal line and slam into a target, tossing it where you started to push adjecent units.",
  Chess_Bishop_Charge_Upgrade1 = "Orthogonal",
  Chess_Bishop_Charge_A_UpgradeDescription = "Allow charging orthogonally.",
  Chess_Bishop_Charge_Upgrade2 = "Phase",
  Chess_Bishop_Charge_B_UpgradeDescription = "Can charge through buildings and units.",
